...
enum
{
	Fixup_Flags__None         = 0 << 0,
        ...
        // Whether this fixup was generated by an assembler macro (e.g. `la`/`lga`). It is an important assumption to
        // known whether a relocation comes from a canonical form, expanded by a macro.
        Fixup_Flags__Macro        = 1 << 3,
};
