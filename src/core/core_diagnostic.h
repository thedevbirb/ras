...
typedef enum DG
{
	...
	DG__Option_Unknown,
	DG__Option_Pop_Unmatched,
	DG__Option_Architecture_Invalid,
...
global const DG_Info DG_Info__table[] =
{
	...
	[DG__Option_Pop_Unmatched]               = { Diagnostic_Kind__Error,   String8__literal(".option pop with no .option push") },
	[DG__Option_Architecture_Invalid]        = { Diagnostic_Kind__Error,   String8__literal("") },
