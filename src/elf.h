...
typedef U16 ELF64_Section_Index;
...
/* Fields in the identifier array.  The EI_* macros are indices into the
...
/* Legal values for object_file_type (object file type).  */
...
/* Legal values for architecture (architecture).  */
...
/* Legal values for object_file_version (version).  */
...
struct ELF32_Section_Header
{
  ...
  Address32	sh_addr;		/* Section virtual addr at execution */
  Offset32	sh_offset;		/* Section file offset */
...
typedef struct
{
  U64	sh_name;		/* Section name (string tbl index) */
  U64	sh_type;		/* Section type */
  U64	sh_flags;		/* Section flags */
  Address64	sh_addr;		/* Section virtual addr at execution */
  Offset64	sh_offset;		/* Section file offset */
  U64	sh_size;		/* Section size in bytes */
  U64	sh_link;		/* Link to another section */
  U64	sh_info;		/* Additional section information */
...
/* How to extract and insert information held in the type_and_binding field.  */

#define ELF32_ST_BIND(val)		(((U8) (val)) >> 4)
#define ELF32_ST_TYPE(val)		((val) & 0xf)
#define ELF32_ST_INFO(bind, type)	(((bind) << 4) + ((type) & 0xf))

/* Both ELF32_Symbol and ELF64_Sym use the same one-byte type_and_binding field.  */
...
/* Legal values for sh_type field of ELF32_Section_Header.  */
...
/* Legal values for sh_flags field of ELF32_Section_Header.  */
...
typedef struct
{
  U32 l_name;		/* Name (string table index) */
  U32 l_time_stamp;	/* Timestamp */
  U32 l_checksum;	/* Checksum */
  U32 l_version;		/* Interface version */
  U32 l_flags;		/* Flags */
} ELF32_Lib;
...
struct ELF64_Lib
{
  U64 l_name;		/* Name (string table index) */
  U64 l_time_stamp;	/* Timestamp */
  U64 l_checksum;	/* Checksum */
  U64 l_version;		/* Interface version */
  U64 l_flags;		/* Flags */
};
